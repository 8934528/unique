...
2. **Clone your fork** locally:
        ...
        bash
        git clone https://github.com/your-username/uniqueid-pro.git
        cd uniqueid-pro
...
- Check if feature already exists or was previously discussed
- Consider the project's scope and vision
...
- Fixes a bug or implements a requested feature
